...
(function ($) {
  ...
  if ($(".testimonial-carousel").length) {
    $(".testimonial-carousel").owlCarousel({
      ...
      responsive: { 0: { items: 1 }, 768: { items: 2 }, 1199: { items: 3 } },
    });
  }
  if ($(".features-carousel").length) {
    $(".features-carousel").owlCarousel({
      ...
      responsive: { 0: { items: 1 }, 1023: { items: 2 }, 1700: { items: 3 } },
    });
  }
  if ($(".features-carousel-boxed").length) {
    $(".features-carousel-boxed").owlCarousel({
      ...
      responsive: { 0: { items: 1 }, 1023: { items: 2 }, 1700: { items: 2 } },
    });
  }
  ...
  if ($(".testimonial-carousel-three").length) {
    $(".testimonial-carousel-three").owlCarousel({
      ...
      responsive: { 0: { items: 1 }, 991: { items: 3 }, 1023: { items: 2 } },
    });
  }
  ...
  if ($(".testimonial-carousel-five").length) {
    $(".testimonial-carousel-five").owlCarousel({
      ...
      responsive: { 0: { items: 1 }, 991: { items: 2 }, 1023: { items: 2 } },
    });
  }
  ...
  if ($(".testimonial-content").length) {
    var testimonial_thumbs = new Swiper(".testimonial-thumbs", {
      ...
      loop: false,
      slidesPerView: 3,
      breakpoints: { 320: { slidesPerView: 3 }, 600: { slidesPerView: 3 } },
    });
